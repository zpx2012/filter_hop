...
void send_SYN(char* payload, unsigned int ack, unsigned int seq = 1, unsigned char ttl = 128);
...
void send_ACK(char* payload, unsigned int ack, unsigned int seq = 1, unsigned char ttl = 128);
void send_spoofed_ACK(char* fake_ip, char* payload, unsigned int ack, unsigned int seq = 1);
void send_request(char* payload, unsigned int ack, unsigned int seq = 1, unsigned char ttl = 128);
